...
const highlightActiveNav = () => {
    ...
    document.querySelectorAll('nav ul li a').forEach(link => {
        var _a;
        const linkPath = (_a = link.getAttribute('href')) === null || _a === void 0 ? void 0 : _a.split('/').pop();
    ...
    if (currentPath === null || currentPath === void 0 ? void 0 : currentPath.startsWith('blog')) {
        (_a = document.querySelector('nav ul li a[href*="blog"]')) === null || _a === void 0 ? void 0 : _a.classList.add('active');
    }
    // Special handling for admin pages
    if (currentPath === null || currentPath === void 0 ? void 0 : currentPath.startsWith('admin')) {
        (_b = document.querySelector('nav ul li a[href*="admin"]') // Assuming admin link doesn't exist in header, this is fine
        ) === null || _b === void 0 ? void 0 : _b.classList.remove('active'); // Remove active if admin link exists
    }
};
// --- Page Specific Logic ---
...
const initializeBlogListing = () => {
    ...
    if (blogGrid && categoryButtons.length > 0) {
        const renderBlogCards = (category = 'All') => {
        ...
        // Initial render
        renderBlogCards('All');
        (_a = document.querySelector('.blog-categories button[data-category="All"]')) === null || _a === void 0 ? void 0 : _a.classList.add('active');
    }
};
...
const initializeAdminDashboard = () => {
    const adminSession = JSON.parse(localStorage.getItem('adminSession') || '{ "isLoggedIn": false }');
